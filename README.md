...
- [Red Blob Games](https://www.redblobgames.com/)
  Learn Algorithms via examples from computer games.
- [OpenDSA - Preface](https://opendsa-server.cs.vt.edu/OpenDSA/Books/CS3/html/index.html#)
- [DSA on Python](https://tira.mooc.fi/spring-2025/)
  A DSA course by University of Helsinki

---

### Problem Sets & Practice

- [CP-Algorithms Tag Index](https://cp-algorithms.com/tags.html)
- [Clash of Code](https://www.codingame.com/multiplayer/clashofcode)
- [CSES Problem Set List](https://cses.fi/problemset/list/)
  Problem list by University of Helsinki.
- [NeetCode Practice](https://neetcode.io/practice)
  Top leetcode problems.
- [USACO Guide Problems](https://usaco.guide/problems/)
- [YouKn0wWho - Ultimate Topic List](https://youkn0wwho.academy/topic-list)
...
- [The Valley of Code by Flavio Copes](https://thevalleyofcode.com/)
  Goated Lessons on Tools, Lanuages related to Web Applications & Networking.
...
- [CTF - Capture the flag (Encodings)](https://vm-thijs.ewi.utwente.nl/ctf/encodings#)
...
- [dCode - Online Ciphers & Solvers](https://www.dcode.fr/en)
...
- [Beginner Friendly Web Dev](https://www.htmldog.com/)
- [Odin Project](https://www.theodinproject.com/)
  Project Based Web Dev from Scratch.
...
- [Build Your Own X (not twitter)](https://github.com/codecrafters-io/build-your-own-x)
  Step-by-step guides to recreate popular tools from scratch.
